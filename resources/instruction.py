...
class InstructionResource(Resource):
    ...
    def put(self, instruction_id):
        ...
        if Instruction is None:
            return {'message': 'Instruciton not found'}, HTTPStatus.NOT_FOUND
    ...
    def patch(self, instruction_id):
        ...
        if errors:
            return {'message': 'Instruction not found'}, HTTPStatus.FORBIDDEN

        instruction = Instruction.get_by_id(instruction_id=instruction_id)

        if instruction is None:
            return {'mesage': 'Instruction not found'}, HTTPStatus.NOT_FOUND
